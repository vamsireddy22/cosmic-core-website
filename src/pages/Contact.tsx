              ...
              <div className="mobile-card">
                ...
                >
                  ...
                  <button
                    ...
                    className="mobile-btn w-full bg-brand-blue text-white hover:bg-brand-teal transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
              ...
              <div className="mobile-card h-full">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="text-brand-blue mr-3 mt-1">
